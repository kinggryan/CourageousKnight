...
do
{
    ...
    if(collision_rectangle(p_to_check.x-BLOCK_SIZE/2,p_to_check.y-BLOCK_SIZE/2,p_to_check.x+BLOCK_SIZE/2,p_to_check.y+BLOCK_SIZE/2,obj_knight,false,true) != noone)
        return true
